    ...
    <div>
      ...
      <div className="project-container">
        ...
        <div className="pdf-viewer-container">
          <iframe
            src="https://drive.google.com/file/d/1AV3KA66_ZFKRzl8pgYWioLSQn83InFv_/preview"
            width="80%"
            height={iframeHeight}
          ...
          >
            ...
            <a href="https://drive.google.com/file/d/1AV3KA66_ZFKRzl8pgYWioLSQn83InFv_/view">
              View PDF directly
            </a>
          </iframe>
        </div>
        ...
        <div className="resume-botton">
          <div className="resume-link">
            <a href="https://drive.google.com/file/d/1AV3KA66_ZFKRzl8pgYWioLSQn83InFv_/view?usp=sharing">
