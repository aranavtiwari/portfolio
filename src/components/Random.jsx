...
import imgfour from '../img/eventlogo.svg';
...
const Random = () => {
 ...
 const projectName = [
    {   weblink:"https://aranavtiwari.github.io/WA/", 
        gitlink:"https://github.com/aranavtiwari/Multiplayer-Snake-game", 
        link:"linkweb", 
        ...
        img:imgone, 
        heading:"MPSG", 
        description:"MPSG is real time multiplayer snake game where two user can play against each other . I developed the frontend with HTML5/CSS and backend with Socket.io"
    },
    {iconweb:"fas fa-globe", 
        nameweb:"Web App", 
        weblink:"https://github.com/aranavtiwari/AI-tictactoe" ,
        icongit:"fab fa-github", 
        gitname:"Github Org", 
        ...
        img:imgtwo, 
        heading:"AITT", 
        description:"Created AI with Minimax Algorithm in Game Theory where a user can play against a AI.It can be implemented on various game like chess, Tic Tac Toe. I choose Tictactoe " 
    },
    {   iconweb:"fas fa-globe", 
        nameweb:"Web App", 
        weblink:"#" ,
        icongit:"fab fa-github", 
        gitname:"Github Org", 
        gitlink:"https://github.com/aranavtiwari?tab=repositories",
        link:"linkweb",   
        class:"float-right ",  
        img:imgthree, 
        heading:"Templates", 
        description:"Create various landing page templates, which can be used by various organization. All templated is pure HTML5 and SASS.The focus is on speed and minimalism"
    },
    {   iconweb:"fas fa-globe", 
        nameweb:"Web App", 
        weblink:"#" ,
